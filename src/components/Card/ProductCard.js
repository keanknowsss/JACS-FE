				...
				<div className="p-3">
					<div className="p-1 bg-[#F66B0E] rounded-t-lg rounded-b-lg relative overflow-hidden drop-shadow-xl">
						<img
							...
							alt=""
						/>
						<div className="absolute bottom-1 left-1 right-1 px-4 py-4 bg-gradient-to-t from-black rounded-b-lg">
							<h3 className="text-xl text-white font-bold">Product Name</h3>
							<p className="mt-2 text-sm text-gray-300 sm:justify-left">
