        ...
        <div className="p-10 bg-background text-gray-200">
          <div className="max-w-6xl mx-auto">
            <div className=" py-6 flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="mt-5 flex flex-row justify-between" >
                <div className="mr-7">
                  <h1>Services</h1> 
                  <ul className="mt-5">
                    <li><a href="/">Repair and Checkup</a></li>
                    <li><a href="/">Computer Tutorials</a></li>
                  </ul>
                </div>
                <div className="mr-7">
                  <h1>Community</h1>
                  <ul className="mt-5">
                    ...
                    <li><a href="/">Suggested Builds</a></li>
                    <li><a href="/">Most bought items</a></li>
                  </ul>
                </div>
                <div className="mr-7">
                  <h1>Company</h1>
            ...
            <div className="mt-7 flex flex-col lg:flex-row justify-between items-center">
              <div>
                © JACS, Inc. 2022. We love our users!
              </div>
