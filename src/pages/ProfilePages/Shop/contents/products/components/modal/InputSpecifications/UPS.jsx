		...
		<>
			...
			<input
				...
				className={`${styles.smallNumber} ${
					error.capacityW ? styles.errorClass : null
				}`}
			...
			<input
				...
				min={0}
				className={`${styles.smallNumber} ${
					error.capacityVA ? styles.errorClass : null
				}`}
			...
			/>
			<label htmlFor="backupRunTimeFullLoad">
				Backup Runtime Full Load (minutes):{" "}
			</label>
			<input
				type="number"
			...
			/>
			<label htmlFor="backupRunTimeHalfLoad">
				Backup Runtime Half Load (minutes):{" "}
			</label>
			<input
				type="number"
			...
			/>
			<label htmlFor="maxBatteryRechargeTime">
				Max Battery Recharge Time (Hour/s):{" "}
			</label>
			<input
				type="number"
