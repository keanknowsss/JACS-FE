	...
	return (
		<>
			...
			<input
				...
				className={`${styles.medText} ${error.speed ? styles.errorClass : null}`}
				value={object.speed}
				onChange={(e) =>
					setObject({
						...object,
			...
			<input
				...
				className={`${error.formFactor ? styles.errorClass : null}`}
			...
			<input
				...
				className={`${styles.medText} ${error.modules ? styles.errorClass : null}`}
			...
			<input
				...
				placeholder="18"
				min={0}
				className={`${styles.smallNumber} ${error.CASLatency ? styles.errorClass : null}`}
			...
			<input
				...
				step="0.01"
				min={0}
				className={`${styles.smallNumber} ${error.voltage ? styles.errorClass : null}`}
			...
			/>
			<label htmlFor="ecc_Registered">ECC / Registered: </label>
			<input
				type="text"
				id="ecc_Registered"
				placeholder="Non-ECC / Unbuffered"
				className={`${styles.medText} ${error.ecc_Registered ? styles.errorClass : null}`}
				value={object.ecc_Registered}
				onChange={(e) =>
					setObject({
						...object,
						ecc_Registered: e.target.value
					})
				}
			/>
