...
export const cpuError = (
	...
	if (!specification.performanceCoreClock) {
		specificationErrorContainer.performanceCoreClock = true;
		specificationErrorMsgArray.push("Core Speed");
	}
	if (!specification.performanceBoostClock) {
		specificationErrorContainer.performanceBoostClock = true;
	...
	if (!specification.microArchitechture) {
		specificationErrorContainer.microArchitechture = true;
...
export const motherboardError = (
	...
	if (!specification.pci16Slots) {
		specificationErrorContainer.pci16Slots = true;
		specificationErrorMsgArray.push("PCIE x16 Slots");
	}
	if (!specification.pci8Slots) {
		specificationErrorContainer.pci8Slots = true;
		specificationErrorMsgArray.push("PCIE x8 Slots");
	}
	if (!specification.pci4Slots) {
		specificationErrorContainer.pci4Slots = true;
		specificationErrorMsgArray.push("PCIE x4 Slots");
	}
	if (!specification.pci1Slots) {
		specificationErrorContainer.pci1Slots = true;
		specificationErrorMsgArray.push("PCIE x1 Slots");
	}
	if (!specification.pciSlots) {
		specificationErrorContainer.pciSlots = true;
	...
	if (!specification.miniPCIe_mSATASlots) {
		specificationErrorContainer.miniPCIe_mSATASlots = true;
		specificationErrorMsgArray.push("Mini PCIE mSata Slots");
	}
	...
	if (!specification.usb3_2Gen1Headers) {
		specificationErrorContainer.usb3_2Gen1Headers = true;
		specificationErrorMsgArray.push("USB 3.2 Gen 1 Headers");
	}
	if (!specification.usb3_2Gen2Headers) {
		specificationErrorContainer.usb3_2Gen2Headers = true;
		specificationErrorMsgArray.push("USB 3.2 Gen 2 Headers");
	}
	if (!specification.usb3_2Gen2x2Headers) {
		specificationErrorContainer.usb3_2Gen2x2Headers = true;
...
export const memoryError = (
	...
	if (!specification.ecc_Registered) {
		specificationErrorContainer.ecc_Registered = true;
...
export const videoCardError = (
	...
	if (!specification.length) {
		specificationErrorContainer.length = true;
...
export const casingError = (
	...
	if (!specification.expansionSlots) {
		specificationErrorContainer.expansionSlots = true;
		specificationErrorMsgArray.push("Expansion Slots");
	}
...
export const powerSupplyError = (
	...
	if (!specification.pcie8pinConnectors) {
		specificationErrorContainer.pcie8pinConnectors = true;
		specificationErrorMsgArray.push("PCIE 12-Pins");
	}
...
export const operatingSystemError = (
	specification,
	specificationErrorContainer,
	specificationErrorMsgArray
) => {
...
export const wiredNetworkAdapterError = (
	specification,
	specificationErrorContainer,
	specificationErrorMsgArray
) => {
...
export const wirelessNetwokAdapterError = (
	specification,
	specificationErrorContainer,
	specificationErrorMsgArray
) => {
...
export const caseAccessoriesError = (
	specification,
	specificationErrorContainer,
	specificationErrorMsgArray
) => {
...
export const fanControllerError = (
	specification,
	specificationErrorContainer,
	specificationErrorMsgArray
) => {
...
export const thermalCompoundError = (
	specification,
	specificationErrorContainer,
	specificationErrorMsgArray
) => {
...
export const externalStorageError = (
	specification,
	specificationErrorContainer,
	specificationErrorMsgArray
) => {
...
export const opticalDriveError = (
	specification,
	specificationErrorContainer,
	specificationErrorMsgArray
) => {
